...
(() => {
    ...
    function setupGeometry(){
        ...
        position = [
            ...
            0.0,  0.5,  0.0, // ひとつ目の頂点の x, y, z 座標
            radius * Math.cos(getAngular(2)), radius * Math.sin(getAngular(2)), 0.0, // ふたつ目の頂点の x, y, z 座標
            radius * Math.cos(getAngular(3)), radius * Math.sin(getAngular(3)), 0.0, // みっつ目の頂点の x, y, z 座標
            0.0,  0.5,  0.0, // ひとつ目の頂点の x, y, z 座標
            radius * Math.cos(getAngular(3)), radius * Math.sin(getAngular(3)), 0.0, // ふたつ目の頂点の x, y, z 座標
            radius * Math.cos(getAngular(4)), radius * Math.sin(getAngular(4)), 0.0, // みっつ目の頂点の x, y, z 座標
        ];
        color = [
